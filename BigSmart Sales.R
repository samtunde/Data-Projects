...
# Load Datasets
setwd("~/Documents/17 Data Sciene Projects/Bigmart Sales")
train <- read.csv("~/Documents/17 Data Sciene Projects/Bigmart Sales/Train.csv")
test <- read.csv("~/Documents/17 Data Sciene Projects/Bigmart Sales/Test.csv")

#check dimensions ( number of row & columns) in data sets
dim(train)
dim(test)
